...
<main class="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-xl mx-auto">
        <div class="bg-white shadow rounded-lg p-8">
            <h2 class="text-3xl font-extrabold text-gray-900 mb-8 text-center">{{ __('Registration') }}</h2>
            ...
            <div class="mt-6">
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-white text-gray-500">{{ __('If you have an account, then') }}</span>
                    </div>
                </div>
