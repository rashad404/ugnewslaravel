...
<nav class="fixed bottom-0 inset-x-0 bg-white shadow flex justify-between text-xs text-gray-700 uppercase font-mono md:hidden">
    ...
    <a href="{{ route('rating.news') }}" class="w-full block py-2 px-3 text-center hover:bg-gray-200">
    ...
    <a href="{{ route('channel.create') }}" class="w-full block py-2 px-3 text-center hover:bg-gray-200">
