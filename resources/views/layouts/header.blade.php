...
<body>
            ...
            <div class="flex justify-between items-center py-4 lg:py-6">
                ...
                <div class="flex-1 flex items-center justify-center px-2 lg:ml-6 lg:justify-end">
                    <div class="max-w-lg w-full lg:max-w-xs relative hidden md:block">
                        ...
                        <div id="headerSearchDropDown" x-show="searchDropdownOpen" x-cloak class="absolute z-10 mt-2 w-full bg-white shadow-lg rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto max-h-96">
    ...
    <div id="mainContentOverlay" x-show="mobileMenuOpen" x-cloak class="fixed inset-0 bg-black opacity-50 z-40"></div>
                ...
                fetch(`/api/search?q=${encodeURIComponent(inputVal)}&countryId={{ $countryId }}`)
                    ...
                    .then(data => {
                        if (headerSearchDropDown) {
                            ...
                            Alpine.store('searchDropdownOpen', true);
                        }
                    })
                    .catch(error => console.error('Error:', error));
            } else {
                Alpine.store('searchDropdownOpen', false);
            }
        }
