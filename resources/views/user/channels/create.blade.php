...
<div class="container mx-auto">
    ...
    <h1 class="text-2xl font-bold mb-4">{{ __('Create Channel') }}</h1>
    ...
    <div id="app">
        <form action="{{ route('user.channels.store') }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4 mt-8">
                ...
                <textarea class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="text" name="text" rows="5"></textarea>
            </div>
