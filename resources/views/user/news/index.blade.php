...
<div class="container mx-auto">
    ...
    <h1 class="text-3xl font-bold mb-6 text-gray-800">{{ __('News Articles') }}</h1>
    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        <form action="{{ route('user.news.index') }}" method="GET" class="w-full md:w-auto">
            <div class="flex">
                <input type="text" name="search" placeholder="{{ __('Search news...') }}"
        ...
        <table class="min-w-full">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('Created at') }}</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    <td class="py-4 pl-4">
                        <img src="{{ Storage::url($article->image ?? 'defaults/news.jpg') }}" alt="{{ $article->title }}" class="w-16 h-16 object-cover rounded">
                    </td>
                    <td class="py-4 px-4">
                    ...
                    <td class="py-4 px-4">
                        <div class="flex space-x-2">
                            ...
                            <a href="{{ route('user.news.edit', $article) }}" class="text-yellow-500 hover:text-yellow-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path
